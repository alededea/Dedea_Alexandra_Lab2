...
namespace Dedea_Alexandra_Lab2.Data
{
    public class Dedea_Alexandra_Lab2Context : DbContext
    {
        ...
        public DbSet<Dedea_Alexandra_Lab2.Models.Category>? Category { get; set; }

        public DbSet<Dedea_Alexandra_Lab2.Models.Member>? Member { get; set; }

        public DbSet<Dedea_Alexandra_Lab2.Models.Borrowing>? Borrowing { get; set; }
    }
}
